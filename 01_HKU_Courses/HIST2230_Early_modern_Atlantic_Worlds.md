...
```mermaid
graph LR
    A[Americas<br/>美洲<br/>1500年] -->|Smallpox, Measles<br/>天花、麻疹| B[Population collapse<br/>人口崩潰<br/>95% died<br/>50年內]
    A -->|Silver, Gold, Tobacco, Sugar<br/>白銀、金、菸草、糖| C[Europe & Africa<br/>歐洲和非洲]
    B -.->|Labor shortage<br/>勞動力短缺| D[African slave trade<br/>非洲奴隸貿易<br/>1260萬人]
    C -->|Horses, Cattle, Wheat, Guns<br/>馬、牛、小麥、槍| E[Americas transformed<br/>美洲被改造]
    C -->|Potatoes, Corn, Tomatoes, Tobacco<br/>馬鈴薯、玉米、番茄、菸草| F[Europe & Asia fed<br/>養活歐亞人口]
    E -->|Sugar, Tobacco, Cotton<br/>蔗糖、菸草、棉花| C
    D -->|Labor<br/>勞動力| E
...
```mermaid
graph LR
    A[Europe<br/>歐洲<br/>槍枝、酒、布匹] --> B[West Africa<br/>西非<br/>奴隸購買]
    B --> C[Middle Passage<br/>中途航程<br/>死亡率15-20%<br/>300人/船]
    C --> D[Caribbean<br/>加勒比海<br/>甘蔗種植園]
    D --> E[Sugar, Cotton, Tobacco<br/>蔗糖、棉花、菸草<br/>產值佔英出口20%] --> F[Europe<br/>歐洲<br/>糖茶消費]
    B -.->|Profits<br/>利潤| G[London financial markets<br/>倫敦金融市場<br/>保險、證券]
    D -.->|Revenue<br/>收入| G
...
```mermaid
graph TD
    A[Atlantic Empire Competition<br/>大西洋帝國競爭<br/>1500-1800] --> B[Spain<br/>西班牙<br/>1500-1700: dominant]
    A --> C[Portugal<br/>葡萄牙<br/>Brazil 1500-1800]
    A --> D[Dutch<br/>荷蘭<br/>1621-1674<br/>West India Company]
    A --> E[France<br/>法國<br/>1660-1763<br/>Canadian & Caribbean]
    A --> F[Britain<br/>英國<br/>1700-1815: dominant<br/>13 colonies + Caribbean islands]
    
    B --> G[Silver empires<br/>銀礦帝國<br/>Potosí每年白銀產量<br/>等於全球其他地區總和]
    F --> H[Sugar empires<br/>蔗糖帝國<br/>Caribbean: Jamaica, Barbados<br/>20% of British exports]
    E --> I[Louisiana & Quebec<br/>的路斯安那+魁北克<br/>1763 lost Caribbean to Britain]
    
    G --> J[Trade balance<br/>貿易平衡]
    H --> J
    style B fill:#f96
    style F fill:#9f6
    style J fill:#f66
...
```mermaid
graph TD
    A[Barbados 1640<br/>1640年的巴巴多斯] -->|Forest → Sugarcane<br/>森林→甘蔗| B[Barbados 1700<br/>1700年的巴巴多斯]
    A -->|Taíno population 20,000<br/>原住民2萬人| A1[People]
    B -->|African slaves 50,000<br/>非洲奴隸5萬人| B1[People]
    A -->|Forest coverage 95%<br/>森林覆蓋率95%| A2[Environment]
    B -->|Forest coverage 5%<br/>森林覆蓋率5%| B2[Environment]
    A -->|Subsistence farming<br/>自給農業| A3[Economy]
    B -->|Monoculture sugar<br/>單一蔗糖經濟| B3[Economy]
    
    B1 -.->|Exploitation<br/>剝削| C[Sugar production<br/>蔗糖產量<br/>15萬噸/年 by 1800]
    B2 -.->|Deforestation<br/>森林破壞| C
    B3 -.->|Wealthy absentees<br/>不在地主| C
    
    C -->|Export to Europe<br/>出口歐洲| D[Sugar consumption<br/>歐洲糖消費<br/>糖茶文化誕生]
    style A fill:#9f6
    style B fill:#f66
...
```mermaid
graph TD
    A[Atlantic History as Method<br/>大西洋史方法論] --> B[Challenges nation-state history<br/>挑戰國別史]
    A --> C[Focuses on networks not states<br/>聚焦網絡而非國家]
    A --> D[Emphasizes connections<br/>強調聯繫]
    A --> E[Risks new Eurocentrism<br/>有新歐洲中心主義風險]
    
    B --> F[British Empire → US → Canada<br/>英帝國→美國→加拿大]
    B --> G[French Empire → Haiti → Louisiana<br/>法帝國→海地→路易斯安那]
    C --> H[Merchant networks<br/>商人網絡]
    C --> I[Religious networks<br/>宗教網絡<br/>Jesuits, Quakers]
    C --> J[Diaspora networks<br/>離散網絡<br/>African, Jewish]
    D --> K[Trade routes<br/>貿易路線]
    D --> L[Disease transmission<br/>疾病傳播]
    D --> M[Idea circulation<br/>思想流通]
    E --> N[Who writes the history?<br/>誰在書寫這段歷史?]
    N --> O[Mostly European archives<br/>主要是歐洲檔案]
    N --> P[African voices missing<br/>非洲人聲音缺失]
    style A fill:#f96
    style E fill:#f66
...
```mermaid
gantt
    title 大西洋世界時間軸 1500-1800
    dateFormat YYYY
    axisFormat %Y
    
    section 帝國
    Portuguese empire      :a1, 1500, 300年
    Spanish empire        :a2, 1519, 280年
    Dutch WIC             :a3, 1621, 153年
    French empire         :a4, 1664, 150年
    British empire        :a5, 1660, 200年
    
    section 關鍵事件
    Columbus 1492         :b1, 1492, 1年
    Potosi silver 1545     :b2, 1545, 1年
    English Armada 1588   :b3, 1588, 1年
    Glorious Rev 1688     :b4, 1688, 1年
    Haitian Rev 1804      :b5, 1804, 1年
```

## Diagram 2: 大西洋世界五大帝國
```mermaid
graph TD
    A[Early Modern Atlantic World<br/>早期現代大西洋世界<br/>1500-1800] --> B[Portugal<br/>葡萄牙<br/>Brazil, Angola, Mozambique<br/>巴西、安哥拉、莫桑比克]
    A --> C[Spain<br/>西班牙<br/>Mexico, Peru, Caribbean<br/>墨西哥、秘魯、加勒比]
    A --> D[Dutch Republic<br/>荷蘭共和國<br/>Netherlands E. Indies, Suriname<br/>荷屬東印度、蘇里南]
    A --> E[France<br/>法國<br/>Canada, Caribbean, Louisiana<br/>加拿大、加勒比、路易斯安那]
    A --> F[Britain<br/>英國<br/>13 colonies, Caribbean, Canada<br/>十三州、加勒比、加拿大]
    
    B --> G[Silver & Gold<br/>銀礦金礦]
    C --> G
    E --> H[Sugar & Furs<br/>蔗糖皮草]
    F --> H
    D --> I[Trade & Finance<br/>貿易金融<br/>Amsterdam stock exchange<br/>阿姆斯特丹證券交易所<br/>1602]
    
    G --> J[Global silver economy<br/>全球白銀經濟<br/>50%→China]
    H --> K[Industrial capital<br/>工業資本<br/>Manchester textiles<br/>曼徹斯特紡織]
    I --> K
...
```mermaid
graph LR
    subgraph West Africa Sources
        A1[Senegambia<br/>塞內岡比亞]
        A2[Gold Coast<br/>黃金海岸]
        A3[Bight of Benin<br/>貝寧灣]
        A4[Bight of Biafra<br/>比夫拉灣]
        A5[Central Africa<br/>中非]
        A6[East Africa<br/>東非]
    end
    
    A1 -->|Earliest 1500s| B[Middle Passage<br/>中途航程<br/>平均死亡率15-20%]
    A2 --> B
    A3 --> B
    A4 --> B
    A5 --> B
    
    B -->|Caribbean 40%| C1[Jamaica, Barbados,<br/>Cuba, Haiti<br/>牙買加、巴巴多斯、<br/>古巴、海地]
    B -->|Brazil 35%| C2[Bahia, Rio<br/>巴伊亞、裏約]
    B -->|North America 10%| C3[Virginia, Carolinas<br/>維吉尼亞、卡羅萊納]
    B -->|Other 15%| C4[Spanish Caribbean,<br/>Suriname, etc<br/>其他地區]
...
```mermaid
graph TD
    A[Cross-cultural encounters<br/>跨文化交流<br/>1500-1800] --> B[Religious conversion<br/>宗教改宗]
    A --> C[Language mixture<br/>語言混合<br/>Portuguese creoles]
    A --> D[Food cultures<br/>飲食文化<br/>Sugar, tobacco, chocolate]
    A --> E[Knowledge exchanges<br/>知識交流<br/>Cartography, astronomy]
    
    B -->|Jesuits in China & Brazil| B1[Syncretism<br/>宗教融合<br/>African Catholicism]
    C -->|Mandarin + Portuguese| C1[Macao pidgin<br/>澳門混合語]
    D -->|Cacao + sugar + milk| D1[Chocolate emergence<br/>巧克力誕生<br/>New World invention]
    E -->|Indigenous + European| E1[Hybrid knowledge<br/>混合知識<br/>Columbus's navigators]
...
```mermaid
flowchart TD
    A[Historical questions<br/>歷史問題] --> B[National History?<br/>國別史?]
    A --> C[Transnational?<br/>跨國史?]
    A --> D[Atlantic History?<br/>大西洋史?]
    A --> E[Global History?<br/>全球史?]
    
    B --> B1[British Empire alone<br/>單獨研究英帝國]
    B --> B2[Spain alone<br/>單獨研究西班牙]
    
    C --> C1[Merchant networks<br/>商人網絡<br/>跨國分析]
    C --> C2[Diaspora communities<br/>離散社群<br/>猶太人&非洲人]
    
    D --> D1[Atlantic basin unit<br/>大西洋盆地為單元]
    D --> D2[All three continents<br/>歐美非三洲聯繫]
    
    E --> E1[World-systems<br/>世界體系<br/>Wallerstein]
    E --> E2[Comparative empires<br/>帝國比較<br/>Bayly, Bentley]
    
    B1 -.->|局限| F[Ignores connections<br/>忽視聯繫]
    C1 -.->|挑戰| G[Data availability<br/>數據可得性]
    D1 -.->|爭論| H[Eurocentric?<br/>歐洲中心?]
    E1 -.->|爭論| I[Macro too broad?<br/>過於宏觀?]
