...
```mermaid
graph LR
    A[俄羅斯的專制-革命鐘擺] --> B[沙皇專制<br/>1900年代]
    B --> C[1905年革命<br/>失敗]
    C --> D[1917年革命<br/>二月+十月]
    D --> E[蘇聯專制<br/>史太林主義]
    E --> F[1991年崩潰<br/>蘇聯解體]
    F --> G[葉利欽自由主義<br/>混亂+失序]
    G --> H[普京威權主義<br/>2000年代至今]
...
```mermaid
graph LR
    A[俄烏戰爭的歷史根源] --> B[1990年代<br/>北約東擴]
    A --> C[2004年<br/>橙色革命]
    A --> D[2014年<br/>克里米亞兼併]
    A --> E[2022年<br/>全面入侵]
    
    B --> B1[俄羅斯視為<br/>安全威脅]
    C --> C1[烏克蘭親歐盟<br/>遠離俄羅斯]
    D --> D1[頓巴斯戰爭<br/>開始]
    E --> E1[戰爭持續<br/>約50萬傷亡]
...
```mermaid
graph LR
    A[俄羅斯的專制-革命鐘擺] --> B[沙皇專制<br/>Romanov dynasty]
    B -->|1905革命| C[短暫自由化<br/>短暫]
    C -->|1917二月革命| D[臨時政府<br/>弱勢]
    D -->|1917十月革命| E[布爾什維克專政<br/>史太林主義]
    E -->|1991崩潰| F[葉利欽自由主義<br/>寡頭+失序]
    F -->|1999普京| G[威權主義復辟<br/>新沙皇]
    G -->|2022侵烏| H[帝國主義戰爭<br/>危機深化]
...
gantt
    ...
    section 擴張
    莫斯科公國 1300-1480      :active1, 1300, 180年
    韃靼枷鎖 1240-1480     :active2, 1240, 240年
    帝國擴張 1480-1917      :active3, 1480, 437年
    蘇聯時期 1917-1991      :active4, 1917, 74年
    普京時代 1999-2030      :active5, 1999, 31年
    
    section 面積
    1300年: 2.5萬km²     :milestone, 1300, 0
    1917年: 2200萬km²     :milestone, 1917, 0
    2022年: 1700萬km²     :milestone, 2022, 0
```

### 圖解 3：1917年革命的階梯
```mermaid
graph LR
    A[1917年革命的階梯] --> B[1905年日俄戰爭失敗<br/>觸發革命]
    B --> C[1917年2月<br/>群眾遊行+軍隊倒戈]
    C --> D[沙皇退位<br/>臨時政府成立]
    D --> E[布爾什維克承諾<br/>土地+麵包+和平]
    E --> F[1917年11月7日<br/>十月革命]
    F --> G[內戰爆發<br/>1918-1922]
    G --> H[布爾什維克勝利<br/>蘇維埃政權鞏固]
...
```mermaid
graph TD
    A[蘇聯興衰的結構因素] --> B[計劃經濟<br/>技術落後]
    A --> C[意識形態<br/>合法性不足]
    A --> D[帝國主義<br/>加盟共和國]
    A --> E[冷戰軍備<br/>經濟負擔]
    
    B --> B1[1970年代停滯<br/>技術差距擴大]
    C --> C1[1985年glasnost<br/>真相曝光]
    D --> D1[民族主義<br/>加盟國獨立]
    E --> E1[軍備競賽<br/>拖垮經濟]
    
    B1 & C1 & D1 & E1 --> F[1991年崩潰]
...
```mermaid
graph LR
    A[俄烏戰爭的歷史根源] --> B[1990年代<br/>北約東擴爭議]
    A --> C[2008年<br/>布加勒斯特峰會]
    A --> D[2014年<br/>克里米亞危機]
    A --> E[2022年<br/>全面入侵]
    
    B --> B1[葉利欽：北約不東擴<br/>布萊爾：北約將擴大]
    
    C --> C1[布殊：烏克蘭+喬治亞<br/>將加入北約]
    C1 --> C2[普京：北約威脅<br/>不可接受]
    
    D --> D1[克里米亞兼併<br/>頓巴斯戰爭開始]
    D1 --> D2[明斯克協議<br/>失敗]
