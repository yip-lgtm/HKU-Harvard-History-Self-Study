...
```mermaid
graph LR
    A[Media & Tourism Industry<br/>媒體與旅遊業] --> B[Pre-constructs destination<br/>預先建構目的地形象]
    B --> C[Tourist arrives<br/>遊客到達]
    C --> D[Tourist Gaze<br/>遊客凝視]
    D --> E["Sees" pre-constructed image<br/>「看到」預先建構的形象]
    E --> F[Satisfaction<br/>滿足]
    E -->|Or| G[Disappointment<br/>失望<br/>Image vs reality]
    F --> H[Recommends to others<br/>向他人推薦]
    H --> A
```
...
```mermaid
graph TD
    A[Tourism & National Identity<br/>旅遊與民族身份] --> B[Heritage sites selected<br/>遺產地點被選擇]
    A --> C[Which history is shown?<br/>什麼歷史被展示?]
    A --> D[Which is hidden?<br/>什麼被隱藏?]
    
    B --> E[Power decides<br/>權力決定]
    E --> F[State interests<br/>國家利益]
    E --> G[Commercial interests<br/>商業利益]
    
    C --> H[Victorious history<br/>勝利者的歷史]
    C --> I[Heroic narratives<br/>英雄敘事]
    C --> J[Approved ethnic groups<br/>獲批准展示的族群]
    
    D --> K[Contested history<br/>爭議歷史]
    D --> L[Defeated groups<br/>失敗群體]
    D --> M[Alternative memories<br/>另類記憶]
...
```mermaid
graph LR
    A[Tourist<br/>遊客] -->|Pays full price| B[Foreign tour operator<br/>外國旅行社<br/>TUI, Booking.com]
    B -->|Keeps 50-60%| C[Foreign airlines<br/>外國航空公司]
    B -->|Keeps 20-30%| D[Foreign hotel chains<br/>外國酒店連鎖]
    B -->|Remainder| E[Local economy<br/>當地經濟<br/>10-20%]
    
    E --> F[Local jobs: low-wage<br/>本地工作：低薪]
    E --> G[Environment: degraded<br/>環境：退化]
    E --> H[Culture: commodified<br/>文化：商品化]
...
```mermaid
graph TD
    A[Memory politics & tourist landscape<br/>記憶政治與旅遊景觀] --> B[State selects history<br/>國家選擇歷史]
    A --> C[Commercial selects history<br/>商業選擇歷史]
    A --> D[Local communities resist<br/>當地社區抵抗]
    
    B --> E[What to commemorate?<br/>紀念什麼?]
    B --> F[What to forget?<br/>遺忘什麼?]
    
    C --> G[What sells?<br/>什麼有銷路?]
    C --> H[Heritage branding<br/>遺產品牌化]
    
    D --> I[Alternative narratives<br/>另類敘事]
    D --> J[Grassroots heritage<br/>基層遺產保護]
