...
```mermaid
graph LR
    A["伊斯蘭黃金時代知識來源"] --> B["希臘哲學<br/>亞里士多德《工具論》"]
    A --> C["波斯行政制度<br/>官僚體系"]
    A --> D["印度數學<br/>代數學、零"]
    A --> E["中國造紙術<br/>知識普及工具"]
    B --> F["巴格達翻譯運動"]
...
```mermaid
graph TD
    A["十字軍東征"] --> B["1096-1099 第一次<br/>佔領耶路撒冷屠殺"]
    B --> C["1147-1149 第二次<br/>大馬士革之戰"]
    C --> D["1187 薩拉丁收復耶路撒冷"]
    D --> E["1189-1192 第三次<br/>狮心王理查"]
    E --> F["1218-1221 第五次<br/>埃及"]
    F --> G["1244 耶路撒冷最終陷落"]
    G --> H["1291 阿卡陷落<br/>十字軍國家滅亡"]
    style H fill:#FF6B6B
```
...
```mermaid
graph LR
    A["伊斯蘭世界地理範圍"] --> B["伊比利亞半島<br/>西班牙、葡萄牙"]
    A --> C["北非<br/>摩洛哥至埃及"]
    A --> D["中東<br/>阿拉伯至波斯"]
    A --> E["中亞<br/>突厥斯坦"]
    A --> F["南亞<br/>印度、巴基斯坦"]
