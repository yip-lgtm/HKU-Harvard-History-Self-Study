...
gantt
    ...
    section 華人移民
    Early settlers        :a1, 1840, 10年
    Shanghai entrepreneurs:a2, 1920, 20年
    1949 refugees        :a3, 1949, 10年
    1990s Mainlanders   :a4, 1990, 30年
    
    section 南亞裔移民
    Indian sepoys       :b1, 1840, 100年
    Pakistani merchants  :b2, 1880, 80年
    Nepali Gurkhas      :b3, 1900, 90年
    Indian merchants     :b4, 1920, 60年
    
    section 重大節點
    1997 Handover      :c1, 1997, 1y
    BNO controversy     :c2, 2020, 5y
```
...
```mermaid
graph TD
    A[South Asian communities in Hong Kong<br/>香港南亞裔社群] --> B[Indian community<br/>印度裔社群<br/>Mostly Punjabi Sikh<br/>主要來自旁遮普邦錫克教徒<br/>1840s-present]
    A --> C[Pakistani community<br/>巴基斯坦裔社群<br/>Mostly Muslim<br/>主要來自開伯爾-普什圖<br/>1880s-present]
    A --> D[Nepalese community<br/>尼泊爾裔社群<br/>Gurkha soldiers<br/>廓爾喀士兵<br/>1900s-present]
    A --> E[Sri Lankan community<br/>斯里蘭卡裔社群<br/>Smaller population<br/>人口較少<br/>1940s-present]
    
    B --> B1[Police force<br/>警隊]
    B --> B2[Indian Chamber of Commerce<br/>印度商會]
    B --> B3[Gurdwaras<br/>錫克教寺]
    
    C --> C1[Small businesses<br/>小商戶]
    C --> C2[Mosques<br/>清真寺]
    
    D --> D1[Military<br/>軍隊]
    D --> D2[Security services<br/>保安服務]
    
    E --> E1[Limited records<br/>記錄有限]
...
```mermaid
graph LR
    A[Archival sources<br/>檔案來源] --> B[HK Records Office<br/>香港歷史檔案館<br/>Colonial administrative records<br/>殖民行政記錄]
    A --> C[British National Archives<br/>英國國家檔案館<br/>Kew Gardens<br/>印度事務檔案]
    A --> D[Religious institutions<br/>宗教機構記錄<br/>Gurdwaras, Mosques<br/>寺廟]
    A --> E[Oral testimonies<br/>口述史料<br/>Elderly community members<br/>社區長者]
    A --> F[Family documents<br/>家族文件<br/>Photos, letters<br/>照片書信]
    A --> G[India Office Records<br/>英國圖書館<br/>India Office Records]
    
    B --> H[Government reports<br/>政府報告]
    B --> I[Immigration records<br/>移民記錄]
    B --> J[Police records<br/>警隊記錄]
...
```mermaid
graph LR
    A[Citizenship history<br/>公民身份歷史] --> B[Colonial period 1842-1945<br/>殖民時期<br/>British subject status<br/>英帝國臣民地位]
    A --> C[Post-war 1945-1980s<br/>戰後時期<br/>Post-independence ambiguity<br/>獨立後身份模糊]
    A --> D[1980s-1997<br/>過渡時期<br/>Sino-British negotiations<br/>中英談判]
    A --> E[Post-1997<br/>回歸後<br/>HKSAR Basic Law<br/>基本法框架]
    
    B --> B1[Full rights<br/>完整權利<br/>As British subjects]
    C --> C1[Citizenship ambiguity<br/>公民身份模糊]
    D --> D1[BNO controversy<br/>BNO 護照爭議]
    E --> E1[National Security Law<br/>國安法<br/>BNO vs SAR passports<br/>BNO vs 特區護照]
