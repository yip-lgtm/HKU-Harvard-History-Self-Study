...
```mermaid
graph LR
    A[Locke's Political Philosophy<br/>洛克的政治哲學<br/>1632-1704] --> B[American Revolution<br/>美國革命<br/>1775-1783]
    B --> C[French Revolution<br/>法國大革命<br/>1789-1794]
    C --> D[Haitian Revolution<br/>海地革命<br/>1791-1804]
    D --> E[Latin American Independence<br/>拉美獨立運動<br/>1810-1825]
    E --> F[British Pivot to Asia<br/>英帝國轉向亞洲<br/>1830s-1840s]
    A --> C
    B -.-> G[Print culture<br/>印刷文化<br/>小冊子&報紙]
    C -.-> G
    G -.-> D
    style A fill:#f96
    style D fill:#f66
...
```mermaid
graph TD
    A[French Revolution 1789<br/>法國大革命] --> B{1793 Crisis:<br/>War + Famine}
    B --> C[Jacobin Reign of Terror<br/>雅各賓恐怖統治<br/>1793-1794]
    C --> D[N decrees emancipation<br/>廢奴令 1794<br/>Need slave soldiers]
    D --> E[Saint-Domingue slaves<br/>武裝加入法軍]
    E --> F[Napoleon 1802<br/>Restores slavery<br/>恢復奴隸制]
    F --> G[Toussaint Louverture<br/>arrested 1802<br/>杜桑被捕]
    G --> H[Jean-Jacques Dessalines<br/>1804 Haitian Independence<br/>海地獨立]
    H --> I[First Black Republic<br/>first modern republic<br/>人類首個黑人共和國]
    style A fill:#f96
    style H fill:#c00
    style I fill:#f66
    style F fill:#ff9
...
```mermaid
graph TD
    A[American Revolution 1783<br/>美國革命失敗<br/>英失去13殖民地] --> B[British Empire<br/>英帝國重新配置]
    B --> C1[India: East India Company<br/>印度: 東印度公司<br/>棉紡織品→全球市場]
    B --> C2[China: Tea trade<br/>中國: 茶葉貿易<br/>白銀流出→鴉片進口]
    B --> C3[Caribbean: Sugar<br/>Caribbean: 蔗糖<br/>廢奴後轉向契約勞工]
    C1 --> D[British Raj<br/>英屬印度<br/>1858-1947]
    C2 --> E[Opium Wars 1839-42<br/>鴉片戰爭<br/>不平等條約體系]
    C3 --> F[Indentured labor<br/>契約勞工制度<br/>印度→Caribbean&東南亞]
    style A fill:#f96
    style D fill:#c00
    style E fill:#f66
```
...
```mermaid
graph TD
    A[Atlantic Revolutions<br/>1780s-1820s<br/>大西洋革命<br/>殖民地市場動蕩] --> B[British Empire<br/>needs new markets<br/>英帝國需要新市場]
    B --> C[China: Tea, Silk, Porcelain<br/>中國: 茶葉、絲綢、瓷器]
    C --> D[Trade deficit:<br/>每年300萬兩<br/>白銀流失]
    D --> E[SOLUTION:<br/>Opium from Bengal<br/>印度孟加拉<br/>鴉片替代白銀]
    E --> F[Opium reverses deficit<br/>逆轉貿易逆差]
    F --> G[China bans opium<br/>1838林則徐禁菸]
    G --> H[First Opium War 1839<br/>第一次鴉片戰爭]
    H --> I[Treaty of Nanking 1842<br/>南京條約<br/>香港島割讓]
    style A fill:#f96
    style H fill:#c00
    style I fill:#f66
```
...
gantt
    ...
    美國獨立戰爭         :a1, 1775, 8年
    法國大革命           :a2, 1789, 5年
    聖多明戈奴隸起義     :a3, 1791, 13年
    拉丁美洲獨立運動     :a4, 1810, 15年
    
    section 關鍵條約
    巴黎條約 1783       :b1, 1783, 1年
    廢奴令 1794         :b2, 1794, 1年
    恢復奴隸制 1802     :b3, 1802, 1年
    海地獨立 1804        :b4, 1804, 1年
    南京條約 1842        :b5, 1842, 1年
    
    section 帝國轉向
    馬戛爾尼使華 1793   :c1, 1793, 1年
    東印度公司擴張      :c2, 1780, 80年
    鴉片戰爭 1839       :c3, 1839, 3年
```

## Diagram 2: 大西洋革命四位一體
```mermaid
graph TD
    A[大西洋革命<br/>1760-1830] --> B[American Revolution<br/>美國革命<br/>1775-1783]
    A --> C[French Revolution<br/>法國大革命<br/>1789-1794]
    A --> D[Haitian Revolution<br/>海地革命<br/>1791-1804]
    A --> E[Latin American Independence<br/>拉美獨立<br/>1810-1825]
    B --> F[Shared ideas:<br/>Locke's liberalism<br/>洛克自由主義]
    C --> F
    D --> F
    E --> F
    B --> G[Shared enemy:<br/>Imperial monopoly<br/>帝國壟斷]
    C --> G
    D --> G
    E --> G
    F --> H[Outcomes:<br/>帝國重組<br/>帝國轉向亞洲]
    G --> H
    style A fill:#f96,stroke:#c00,color:#fff
    style F fill:#9f6
    style G fill:#9f6
    style H fill:#f66
```
...
```mermaid
graph LR
    A[Africa<br/>非洲<br/>奴隸出口] --> B[Middle Passage<br/>中途航程<br/>死亡率15-20%]
    B --> C[Caribbean<br/>加勒比海<br/>蔗糖種植園]
    C --> D[European Markets<br/>歐洲市場<br/>蔗糖利潤30%外匯]
    D --> E[Capital reinvestment<br/>資本再投資]
    E --> F1[India<br/>印度<br/>棉紡織品]
    E --> F2[China<br/>中國<br/>茶葉進口]
    F1 --> G[British Empire<br/>英帝國<br/>重新配置]
    F2 --> G
...
```mermaid
graph TD
    A[Revolutionary Period<br/>革命時期 1760-1830] --> B[Who led? 誰領導]
    A --> C[Who fought? 誰戰鬥]
    A --> D[Who benefited? 誰受益]
    
    B --> B1[American: planter elites<br/>美國: 種植園精英]
    B --> B2[French: bourgeoisie + sans-culottes<br/>法國: 資產階級+無褲漢]
    B --> B3[Haitian: slaves + free people of color<br/>海地: 奴隸+自由有色人]
    B --> B4[Latin: criollos + mestizos<br/>拉美: 土生白人+混血種]
    
    C --> C1[Continental Army<br/>大陸軍]
    C --> C2[National Convention<br/>國民公會]
    C --> C3[Former slaves + black officers<br/>前奴隸+黑人軍官]
    C --> C4[Criollo militias<br/>土生白人民兵]
    
    D --> D1[Landowners + merchants<br/>地主+商人]
    D --> D2[Bourgeoisie gains power<br/>資產階級獲得權力]
    D --> D3[Former slaves free, then isolated<br/>奴隸自由但經濟孤立]
    D --> D4[Caudillos emerge<br/>考迪羅獨裁者興起]
...
```mermaid
flowchart TD
    A[Primary Source<br/>一手史料] --> Q1{Who wrote?<br/>誰寫的?}
    Q1 --> B1[Official: French National Archive<br/>官方: 法國國家檔案]
    Q1 --> B2[Slaveowner letters<br/>奴隸主書信]
    Q1 --> B3[Plantation records<br/>種植園記錄]
    Q1 --> B4[Former slave testimony<br/>前奴隸證詞<br/>extremely rare]
    
    B1 --> C1[Reflects state interest<br/>反映國家利益]
    B2 --> C2[Justifies slavery<br/>為奴隸制辯護]
    B3 --> C3[Economic data reliable<br/>經濟數據可信]
    B4 --> C4[Critical perspective<br/>批判性視角]
    
    C1 --> D[Cross-check with other sources<br/>交叉驗證]
    C2 --> D
    C3 --> D
    C4 --> D
    
    D --> E1[Count slave population<br/>統計奴隸人口]
    D --> E2[Map trade networks<br/>繪製貿易網絡]
    D --> E3[Trace revolutionary ideas<br/>追蹤革命思想]
    D --> E4[Reconstruct lived experience<br/>重建生活經驗]
    
    E1 --> F[Historical Argument<br/>歷史論證]
    E2 --> F
    E3 --> F
    E4 --> F
