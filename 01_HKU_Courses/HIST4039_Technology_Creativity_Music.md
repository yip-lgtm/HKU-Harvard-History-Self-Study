...
```mermaid
graph LR
    A[Pre-1877: Live performance<br/>1877年前：現場表演] -->|Edison phonograph 1877| B[1900-1960: Recording era<br/>1900-1960：錄音時代]
    B -->|CD technology 1982| C[1980-2000: CD era<br/>1980-2000：CD時代]
    C -->|MP3 & P2P 1999| D[2000-2010: Digital crisis<br/>2000-2010：數位危機]
    D -->|Spotify 2008| E[2010-present: Streaming era<br/>2010-：流媒體時代]
    
    A --> A1[Performer power<br/>表演者權力<br/>Full creative control<br/>完全創意控制]
    B --> B1[Record company power<br/>唱片公司權力<br/>Distribution monopoly<br/>分銷壟斷]
    C --> C1[Peak corporate power<br/>唱片公司權力高峰<br/>Physical media monopoly<br/>實體媒體壟斷]
    D --> D1[Transition chaos<br/>過渡時期混亂<br/>Piracy explosion<br/>盜版爆炸]
    E --> E1[Platform power<br/>平台權力<br/>Spotify, Apple Music, Tencent<br/>平台主導價值鏈]
...
```mermaid
graph LR
    A[User pays $10/month<br/>用戶月費10美元] --> B[Spotify keeps 30%<br/>Spotify留30%<br/>Operating costs + profit<br/>運營成本+利潤]
    A --> C[Record companies 50-60%<br/>唱片公司獲50-60%<br/>Sony, Universal, Warner<br/>三大唱片公司]
    A --> D[Artists: 10-20%<br/>藝術家：10-20%<br/>After label deduction<br/>唱片公司扣減後]
    
    D --> E[1000 plays = $3-5<br/>1000播放=3-5美元]
    E --> F[Need 1 million plays/month<br/>每月需要100萬播放<br/>To earn US minimum wage<br/>才能達到美國最低工資]
    
    C --> G[Major labels negotiate<br/>大唱片公司談判能力強]
    G --> H[Indie labels get less<br/>獨立唱片公司獲得更少]
...
```mermaid
flowchart LR
    A[Recording contract<br/>錄音合約] --> B[Record company advances<br/>唱片公司墊付錄音成本]
    B --> C[Artist records album<br/>藝術家錄製專輯]
    C --> D[Company keeps 50%+<br/>公司保留50%以上利潤]
    D --> E[Artist repays advance<br/>藝術家償還墊付成本]
    E -->|Most artists never recoup| F[Artist earns nothing<br/>藝術家分文未得]
    E -->|But artist still owns| G[Master recordings<br/>母帶所有權歸公司]
    F --> H[Company: Profit<br/>公司：盈利]
...
```mermaid
graph LR
    subgraph "Global South music markets"
        A1[Latin America<br/>拉丁美洲<br/>Reggaeton, Salsa<br/>Streaming growth 43%/yr]
        A2[Africa<br/>非洲<br/>Afrobeats, Amapiano<br/>Nigerian market $100M+]
        A3[South Asia<br/>南亞<br/>Bollywood music<br/>Bollywood: $1.3B industry]
        A4[China<br/>中國<br/>Streaming dominance<br/>QQ Music, NetEase<br/>800M users]
    end
    
    subgraph "Western music industry"
        B1[US/Europe<br/>美國/歐洲<br/>Streaming saturated<br/>Spotify dominates]
        B2[Indie artists<br/>獨立藝術家<br/>Struggle for visibility<br/>為可見度掙扎]
    end
    
    A4 --> C[Tencent Music: 900M users<br/>騰訊音樂：9億用戶]
    B1 --> D[Spotify: 500M users<br/>Spotify：5億用戶]
...
```mermaid
timeline
    title Evolution of Recording Technology
    1877 : Edison phonograph<br/>Sound fixation begins
    1888 : Berliner gramophone<br/>Mass reproduction
    1920 : Radio broadcasting<br/>Free music era
    1948 : LP long-playing record<br/>Album format
    1958 : Stereo sound<br/>Immersive listening
    1963 : Cassette tape<br/>Portability
    1982 : CD player<br/>Digital audio
    1999 : MP3 / Napster<br/>Digital piracy
    2003 : iTunes Store<br/>Legal digital sales
    2008 : Spotify launch<br/>Streaming era
    2015 : Apple Music<br/>Platform competition
    2020 : AI-generated music<br/>Ethical crisis
```
