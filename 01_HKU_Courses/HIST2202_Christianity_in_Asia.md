...
```mermaid
graph TD
    A["中國基督教歷史分期"] --> B["早期：景教時期<br/>635-845"]
    A --> C["中期：耶穌會時期<br/>1583-1800"]
    A --> D["近代：新教時期<br/>1807-1949"]
    A --> E["當代：政治化時期<br/>1949-"]
    
    C --> C1["利瑪竇適應策略"]
    C --> C2["中國禮儀之爭<br/>1704年禁令"]
    D --> D1["1900年義和團"]
    D --> D2["燕京大學<br/>1919年"]
    E --> E1["三自運動 1950"]
    E --> E2["地下教會 1950-"]
...
```mermaid
graph LR
    A["傳教運動"] --> B["正面貢獻<br/>大學.醫院.慈善"]
    A --> C["負面關聯<br/>帝國主義.種族主義"]
    B --> B1["燕京大學<br/>協和醫院"]
    C --> C1["不平條約附帶<br/>『白人的負擔』"]
