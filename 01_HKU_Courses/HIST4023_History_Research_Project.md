...
```mermaid
flowchart TD
    A[Good research question<br/>好的研究問題] --> B[Historical significance<br/>歷史意義]
    A --> C[Research space<br/>研究空間]
    A --> D[Source availability<br/>史料可用性]
    A --> E[Precision<br/>精確性]
    
    B --> B1[Relevance to present<br/>與當代的相關性]
    B1 --> B2[Why does this matter?<br/>這個問題為什麼重要？]
    
    C --> C1[Gap in literature<br/>現有文獻的空白]
    C1 --> C2[What hasn't been answered?<br/>什麼問題還沒有被回答？]
    
    D --> D1[Primary sources accessible<br/>一手史料可接觸]
    D1 --> D2[Language & archive access<br/>語言和檔案獲取能力]
    
    E --> E1[7,000 words scope<br/>7,000詞範圍內可回答]
    E1 --> E2[One clear question<br/>一個清晰的問題]
...
flowchart TD
    ...
    Q1 -->|Private letter<br/>私人書信| B2[Intimate audience?<br/>私密讀者?]
    Q1 -->|Newspaper<br/>報紙| B3[Which paper?<br/>哪份報紙?]
    Q1 -->|Oral testimony<br/>口述| B4[When recorded?<br/>何時記錄?]
    Q1 -->|Photograph<br/>照片| B5[Who took it?<br/>誰拍的?]
    ...
    E --> F[Whose voice is silenced?<br/>誰的聲音被沉默了?]
    F --> G[Cross-check<br/>交叉驗證]
    G --> H[Historical argument<br/>歷史論證]
...
```mermaid
flowchart TD
    A[History essay structure<br/>歷史論文結構] --> B[Introduction<br/>導言<br/>Hook + Thesis + Roadmap]
    B --> C[Chapter 1<br/>第一章<br/>Background + Historiography]
    C --> D[Chapter 2<br/>第二章<br/>Primary source analysis]
    D --> E[Chapter 3<br/>第三章<br/>Evidence + Argument]
    E --> F[Conclusion<br/>結論<br/>Restate + Significance]
    
    B --> B1[Thesis: Clear argument<br/>論點：清晰論證]
    B1 -.->|7,000 words| G[Word count guide<br/>字數指引]
    G --> G1[Intro: 500-700 words<br/>導言：500-700詞]
    G1 --> G2[Lit review: 1,000-1,500 words<br/>文獻綜述：1,000-1,500詞]
    G2 --> G3[Main chapters: 3,000-4,000 words<br/>主章：3,000-4,000詞]
    G3 --> G4[Conclusion: 500-700 words<br/>結論：500-700詞]
...
```mermaid
flowchart TD
    A[Research ethics checklist<br/>研究倫理檢查清單] --> B[Informed consent<br/>知情同意]
    A --> C[Data protection<br/>數據保護]
    A --> D[Source criticism<br/>史料批判]
    A --> E[Impact assessment<br/>影響評估]
    
    B --> B1[Written consent form<br/>書面同意表]
    B1 --> B2[Explain purpose + use<br/>解釋目的和使用]
    
    C --> C1[Secure storage<br/>安全存儲]
    C1 --> C2[Access control<br/>訪問控制]
    
    D --> D1[Identify biases<br/>識別偏見]
    D1 --> D2[Acknowledge silences<br/>承認空白]
    
    E --> E1[Who might be affected?<br/>誰可能受影響？]
    E1 --> E2[Balance truth vs harm<br/>平衡真相與傷害]
