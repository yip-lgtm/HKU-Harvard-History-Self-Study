...
```mermaid
flowchart TD
    A[Discover<br/>發現] --> B[Define<br/>定義]
    B --> C[Develop<br/>發展]
    C --> D[Deliver<br/>交付]
    
    A --> A1[Empathy research<br/>同理心研究]
    A1 --> A2[Identify research gap<br/>識別研究空白]
    
    B --> B1[Form research question<br/>形成研究問題]
    B1 --> B2[Scope project<br/>確定項目範圍]
    
    C --> C1[Prototype solutions<br/>原型解決方案]
    C1 --> C2[Test with stakeholders<br/>與利益相關者測試]
    
    D --> D1[Execute fieldwork<br/>執行田野]
    D1 --> D2[Present findings<br/>呈現發現]
...
```mermaid
flowchart TD
    A[HKU IRB Ethics Application<br/>HKU IRB 倫理申請] --> B[Prepare application<br/>準備申請材料]
    B --> C[Submit to IRB<br/>提交倫理委員會]
    C --> D{Review process<br/>審查過程}
    D -->|Approved<br/>批准| E[Begin fieldwork<br/>開始田野]
    D -->|Revisions required<br/>需要修訂| F[Revise application<br/>修訂申請]
    F --> C
    
    B --> B1[Informed consent form<br/>知情同意表]
    B1 --> B2[Risk assessment<br/>風險評估]
    B2 --> B3[Data management plan<br/>數據管理計劃]
...
```mermaid
flowchart TD
    A[Fieldwork ethics<br/>田野研究倫理] --> B[Before fieldwork<br/>田野研究前]
    A --> C[During fieldwork<br/>田野研究中]
    A --> D[After fieldwork<br/>田野研究後]
    
    B --> B1[Ethics approval<br/>倫理審批]
    B --> B2[Informed consent forms<br/>知情同意表]
    B --> B3[Language preparation<br/>語言準備]
    B --> B4[Community contacts<br/>社區接觸建立]
    
    C --> C1[Participant safety<br/>參與者安全]
    C --> C2[Data backup<br/>數據備份]
    C --> C3[Reflexivity journal<br/>反思日誌]
    C --> C4[Ongoing consent<br/>持續同意]
    
    D --> D1[Anonymization<br/>匿名化處理]
    D --> D2[Community feedback<br/>社區回饋]
    D --> D3[Secure storage<br/>安全存儲]
    D --> D4[Dissemination<br/>發布成果]
...
```mermaid
graph LR
    A[Multi-source integration<br/>多元史料整合] --> B[Chinese archives<br/>中文檔案<br/>香港、內地、台灣]
    A --> C[British archives<br/>英國檔案<br/>Kew Gardens, India Office]
    A --> D[Japanese archives<br/>日文檔案<br/>橫濱、神戶]
    A --> E[Oral testimonies<br/>口述史料<br/>受訪者記憶]
    A --> F[Newspaper archives<br/>報紙檔案<br/>SCMP, 政府公報]
    
    B --> F1[Cross-reference<br/>交叉驗證]
    C --> F1
    D --> F1
    E --> F1
    F --> F1
    
    F1 --> G[Historical argument<br/>歷史論點]
    G --> H[Triangulation<br/>三角測量法<br/>Multiple sources converge<br/>多源匯聚]
...
```mermaid
graph LR
    A[Public history forms<br/>公共歷史形式] --> B[Online journal<br/>在線期刊]
    A --> C[Podcast<br/>播客]
    A --> D[Museum exhibit<br/>博物館展覽]
    A --> E[Documentary<br/>紀錄片]
    A --> F[Blog post<br/>博客文章]
    A --> G[Conference presentation<br/>會議展示]
    
    B --> G1[Academic audience<br/>學術受眾]
    C --> G2[General public<br/>公眾]
    D --> G2
    E --> G2
    F --> G3[Students<br/>學生]
    G --> G1
...
```mermaid
flowchart TD
    A[HIST4028 Process<br/>HIST4028 流程] --> B[Invitation received<br/>收到邀請]
    B --> C[Write project proposal<br/>撰寫項目計劃書]
    C --> D[Panel review<br/>委員會審查]
    D -->|Approved<br/>批准| E[Receive funding<br/>獲得資助]
    D -->|Rejected<br/>拒絕| F[Revise and resubmit<br/>修訂再提交]
    
    E --> G[Design fieldwork<br/>設計田野]
    G --> H[Ethics approval<br/>倫理審批]
    H --> I[Conduct fieldwork<br/>執行田野]
    I --> J[Process findings<br/>處理發現]
    J --> K[Disseminate results<br/>傳播成果]
    
    C --> C1[Research question<br/>研究問題]
    C1 --> C2[Methodology<br/>方法論]
    C2 --> C3[Budget<br/>預算]
    
    K --> K1[Academic paper<br/>學術論文]
    K1 --> K2[Public presentation<br/>公共展示]
    K2 --> K3[Online journal<br/>在線期刊]
