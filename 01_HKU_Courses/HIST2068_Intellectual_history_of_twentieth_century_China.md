...
```mermaid
graph LR
    A["中國回應現代性三階段"] --> B["第一階段：技術<br/>自強運動 1861-95"]
    B -->|"失敗：甲午戰爭"| C["第二階段：制度<br/>戊戌維新 1898"]
    C -->|"失敗：政變流產"| D["第三階段：文化<br/>五四運動 1919"]
    D -->|"部分成功<br/>白話文取代文言文"| E["共產主義勝利<br/>1949"]
    style B fill:#FFE66D
    style C fill:#FFB6C1
    style D fill:#90EE90
```
