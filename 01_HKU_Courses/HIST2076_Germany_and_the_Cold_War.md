...
**Style**: 袁騰飛式 — 犀利批判，聚焦德國點解成為人類歷史上最大意識形態實驗嘅犧牲品
...
```mermaid
graph TD
    A["德國問題四次形態"] --> B["1871 統一問題<br/>點解統一？"]
    A --> C["1918 民主問題<br/>點解民主失敗？"]
    A --> D["1945 罪惡問題<br/>點解大屠殺？"]
    A --> E["1990 統一問題<br/>統一係咪太早？"]
    B --> F["歐洲均勢危機"]
    C --> G["威瑪民主失敗"]
    D --> H["歐洲文明恥辱"]
    E --> I["歐洲新不安"]
...
```mermaid
graph TD
    A["德國記憶政治演變"] --> B["1945-60s<br/>否認+淡化"]
    A --> C["1968學生運動<br/>質問上一代"]
    A --> D["1970-80s<br/>道歉+賠償"]
    A --> E["1990s<br/>整合記憶"]
    A --> F["2000s-至今<br/>歐洲記憶"]
    C --> G["Helmut Schmidt:<br/>『問我父母』"]
    D --> H["1970年維利·勃蘭特<br/>華沙猶太區下跪"]
    F --> I["2021承認<br/>納米比亞殖民罪行"]
    style H fill:#90EE90
```
...
```mermaid
graph TD
    A["冷戰史學流派"] --> B["正統派<br/>美國正義論"]
    A --> C["修正主義<br/>蘇聯威脅論"]
    A --> D["新冷戰史<br/>雙方都有錯"]
    A --> E["後殖民主義<br/>冷戰係全球權力遊戲"]
    B --> F["冷戰=正邪大戰"]
    C --> G["冷戰=蘇聯擴張"]
    D --> H["冷戰=意識形態之爭+大國競爭"]
    E --> I["冷戰=全球不平等"]
...
```mermaid
graph TD
    A["德國記憶政治"] --> B["1945-55<br/>否認+合理化"]
    A --> C["1958-68<br/>起訴+質問"]
    A --> D["1970s-80s<br/>道歉+賠償"]
    A --> E["1990s<br/>記憶制度化"]
    A --> F["2000s-至今<br/>歐洲化記憶"]
    B --> G["戰後否認"]
    D --> H["勃蘭特下跪"]
    E --> I["大屠殺紀念館"]
    F --> J["歐洲記憶倡議"]
