...
flowchart TD
    ...
    B --> F1[Understand partner's needs<br/>理解合作夥伴需求]
    C --> G[Ethical compliance<br/>倫理合規]
    C --> G1[Informed consent<br/>知情同意]
    D --> H[Client feedback<br/>客戶反饋]
    D --> H1[Revise for accessibility<br/>為公共可及性修訂]
    E --> I[Reflexive journal<br/>反思日誌]
    E --> I1[Document learning<br/>記錄學習]
...
flowchart TD
    ...
    H --> I[Member check<br/>受訪者回顧]
    I --> J[Analyze<br/>分析]
    J --> K[Write history<br/>撰寫歷史]
    K --> L[Share with community<br/>與社區分享]
...
graph TD
    ...
    E --> E1[Co-construct knowledge<br/>共同建構知識]
    E1 --> E2[Reciprocal benefit<br/>雙方受益]
...
flowchart TD
    ...
    I --> I1[Better historian<br/>更好的歷史學家]
    I1 --> I2[Better community partner<br/>更好的社區合作者]
