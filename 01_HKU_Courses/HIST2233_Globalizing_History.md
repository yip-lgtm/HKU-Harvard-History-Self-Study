...
**Style**: 袁騰飛式 — 犀利、聚焦大歷史與微觀史的張力——如何用「跨越邊界」的視角重寫世界史
...
```mermaid
graph LR
    A[Transnational network<br/>跨境網絡] --> B[People流<br/>奴隸、商人、傳教士]
    A --> C[Goods流<br/>蔗糖、絲綢、白銀]
    A --> D[Ideas流<br/>宗教、科技、革命思想]
    A --> E[Disease流<br/>天花、流感、黑死病]
    A --> F[Climate流<br/>颶風、季風、厄爾尼諾]
    
    B --> G[Example: Middle Passage<br/>奴隸從非洲→Caribbean]
    C --> H[Example: Silver<br/>白銀從Potosí→歐洲→中國]
    D --> I[Example: Buddhism<br/>佛教從印度→東亞]
    E --> J[Example: Smallpox<br/>天花從歐洲→美洲]
...
```mermaid
graph TD
    A[Comparative empires<br/>比較帝國方法] --> B[British Empire<br/>英帝國<br/>1688-1997<br/>分散式帝國]
    A --> C[Ottoman Empire<br/>奧斯曼帝國<br/>1299-1922<br/>宗教寬容式帝國]
    A --> D[Qing Empire<br/>滿清帝國<br/>1644-1912<br/>文明帝國]
    A --> E[Russian Empire<br/>俄羅斯帝國<br/>1721-1917<br/>陸權擴張式帝國]
    A --> F[Spanish Empire<br/>西班牙帝國<br/>1492-1898<br/>銀礦帝國]
    
    B --> G[Colonial administration<br/>殖民管治]
    C --> H[Millets system<br/>米列特制度<br/>宗教自治社區]
    D --> I[Civilizing mission<br/>文明使命<br/>儒家禮儀]
    E --> J[Russification<br/>俄化政策<br/>強制服從]
    F --> K[Encomienda<br/>恩科米恩達制<br/>強制勞動]
...
```mermaid
graph LR
    A[Commodity chain analysis<br/>商品鏈分析] --> B[Production<br/>生產]
    A --> C[Transportation<br/>運輸]
    A --> D[Trade<br/>貿易]
    A --> E[Consumption<br/>消費]
    
    B --> B1[Sugar: Caribbean slaves<br/>蔗糖：Caribbean奴隸種植]
    B --> B2[Silver: Potosí miners<br/>白銀：波托西礦工]
    B --> B3[Silk: Chinese weavers<br/>絲綢：中國織工]
    
    C --> C1[Shipping routes<br/>航運路線]
    C --> C2[Insurance: Lloyd's of London<br/>保險：倫敦勞埃德]
    
    D --> D1[London auctions<br/>倫敦拍賣行]
    D --> D2[Canton trade<br/>廣州貿易體系]
    D --> D3[Amsterdam exchange<br/>阿姆斯特丹交易所]
    
    E --> E1[British working class<br/>英國工人階級<br/>糖茶消費]
    E --> E2[Chinese consumers<br/>中國消費者<br/>絲綢衣物]
    
    style A fill:#f96
    style B1 fill:#c00,color:#fff
    style D1 fill:#9f6
```
...
```mermaid
graph TD
    A[Scale of analysis<br/>分析尺度] --> B[Big History<br/>大歷史<br/>宇宙/地質尺度<br/>10^18 meters<br/>10^17 seconds]
    A --> C[World history<br/>世界史<br/>文明/帝國尺度<br/>10^9 meters<br/>10^3 years]
    A --> D[National history<br/>國別史<br/>國家/社會尺度<br/>10^6 meters<br/>10^2 years]
    A --> E[Microhistory<br/>微觀史<br/>個人/社區尺度<br/>10^0 meters<br/>10^0-1 years]
    
    B --> F[David Christian<br/>Maps of Time<br/>2004]
    C --> G[Jerry Bentley<br/>World History textbook<br/>1990s]
    D --> H[C.A. Bayly<br/>Birth of Modern World<br/>2004]
    E --> I[Carlo Ginzburg<br/>The Cheese and the Worms<br/>1976]
