...
# HIST2079 早期現代歐洲 / Early Modern Europe, 1500-1800
**學期**：1500-1800
...
### 分歧 1：宗教改革 — 靈性 vs 政治 / Reformation — Spiritual or Political
**核心問題 / Core question**: 宗教改革是靈性覺醒還是政治運動？

- **一方觀點** / **Side A**: A: 靈性 — 路德、加爾文宗教良心
- **另一方觀點** / **Side B**: B: 政治 — 諸侯藉機對抗教宗、世俗化

### 分歧 2：科學革命 — 純粹 vs 政治 / Scientific Revolution — Pure or Political
**核心問題 / Core question**: 科學革命是知識追求還是政治服務？

- **一方觀點** / **Side A**: A: 純粹 — 哥白尼、牛頓、伽利略好奇心
- **另一方觀點** / **Side B**: B: 政治 — 航海需要、軍事技術、君權正當性

### 分歧 3：啟蒙 — 普世 vs 歐洲中心 / Enlightenment — Universal or Eurocentric
**核心問題 / Core question**: 啟蒙運動是普世理性還是歐洲中心？

- **一方觀點** / **Side A**: A: 普世 — 天賦人權、理性
- **另一方觀點** / **Side B**: B: 歐洲中心 — 種族主義、殖民主義正當化
...
1. 為什麼 **宗教改革的深遠影響** 是理解 早期現代歐洲 的第一前提？這個假設如果不成立，整個分析會如何崩塌？
2. 印刷術與公眾領域 在多大程度上決定了 Early Modern Europe, 1500-1800 的核心走向？歷史上有哪些反例挑戰這個邏輯？
3. 絕對王權的興衰 與 科學革命 之間的張力如何形塑了 1500-1800 的關鍵轉折？
4. 如果把 宗教改革的深遠影響 抽離出來，Early Modern Europe, 1500-1800 會變成什麼樣的歷史？哪些事件其實是 noise？
5. 在 1500-1800 中，哪個領導人、事件或文本最能代表 啟蒙運動的雙刃性 的極致展現？
6. 學者之間關於 印刷術與公眾領域 的爭論，在多大程度上反映了史料解釋的差異 vs 意識形態的對抗？
7. 對 Early Modern Europe, 1500-1800 而言，『帝國主義』是分析的核心還是後人強加的框架？
8. 從 US Military Weapons Project 角度，1500-1800 的哪些節點直接決定了美軍在亞洲的部署邏輯？
9. 如果你是當時的決策者，面對 絕對王權的興衰 與 科學革命 的衝突，你會選擇哪個？理由是什麼？
10. 在當代中美對抗背景下，Early Modern Europe, 1500-1800 的哪些歷史經驗正在重演？哪些已經過時？
...
很多教科書把 Early Modern Europe, 1500-1800 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 宗教改革的深遠影響 的兩個極端案例，並分析其後果
- 如果抽離 宗教改革的深遠影響，Early Modern Europe, 1500-1800 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，宗教改革的深遠影響 怎樣決定了 1500-1800 的地緣政治？
...
| 英文概念 | 中英對照 | 歷史含義 | 武器 / 軍事應用 |
|---|---|---|---|
| 印刷術與公眾領域 | 印刷術與公眾領域 | 核心定義 | 武器 / 軍事應用 |
| Period dynamics | 時代動力 | 時代特徵 | 戰略選擇 |
| Power relations | 權力關係 | 主導者 | 強制工具 |
| Historical agency | 歷史能動性 | 誰在塑造 | 自主 vs 結構 |
...
### 1.3 袁騰飛式犀利觀察 / Sharp observation
講 印刷術與公眾領域 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 Early Modern Europe, 1500-1800 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 印刷術與公眾領域 的兩個極端案例，並分析其後果
- 如果抽離 印刷術與公眾領域，Early Modern Europe, 1500-1800 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，印刷術與公眾領域 怎樣決定了 1500-1800 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[印刷術與公眾領域 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
### 1.3 袁騰飛式犀利觀察 / Sharp observation
講 絕對王權的興衰 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 Early Modern Europe, 1500-1800 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 絕對王權的興衰 的兩個極端案例，並分析其後果
- 如果抽離 絕對王權的興衰，Early Modern Europe, 1500-1800 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，絕對王權的興衰 怎樣決定了 1500-1800 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[絕對王權的興衰 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
### 1.3 袁騰飛式犀利觀察 / Sharp observation
講 科學革命 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 Early Modern Europe, 1500-1800 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 科學革命 的兩個極端案例，並分析其後果
- 如果抽離 科學革命，Early Modern Europe, 1500-1800 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，科學革命 怎樣決定了 1500-1800 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[科學革命 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
| 英文概念 | 中英對照 | 歷史含義 | 武器 / 軍事應用 |
|---|---|---|---|
| 啟蒙運動的雙刃性 | 啟蒙運動的雙刃性 | 核心定義 | 武器 / 軍事應用 |
| Period dynamics | 時代動力 | 時代特徵 | 戰略選擇 |
| Power relations | 權力關係 | 主導者 | 強制工具 |
| Historical agency | 歷史能動性 | 誰在塑造 | 自主 vs 結構 |
...
### 1.3 袁騰飛式犀利觀察 / Sharp observation
講 啟蒙運動的雙刃性 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 Early Modern Europe, 1500-1800 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 啟蒙運動的雙刃性 的兩個極端案例，並分析其後果
- 如果抽離 啟蒙運動的雙刃性，Early Modern Europe, 1500-1800 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，啟蒙運動的雙刃性 怎樣決定了 1500-1800 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[啟蒙運動的雙刃性 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
**Q3.** Early Modern Europe, 1500-1800 的歷史經驗如何理解當代中美關係？
...
**Q9.** Early Modern Europe, 1500-1800 對美軍在亞洲部署有何深遠影響？
...
**自學建議 / Study tips**: 配合 Early Modern Europe, 1500-1800 教科書 + Harvard 課程視頻 + 中英對照史料，輸出讀書筆記到 `06_Reading_Notes/`。
