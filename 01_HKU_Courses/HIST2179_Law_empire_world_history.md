...
**Style**: 袁騰飛式 — 犀利批判，聚焦「法治」到底係文明工具定係帝國主義借口
...
```mermaid
graph TD
    A["國際法歷史演變"] --> B["1648威斯特伐利亞：<br/>歐洲主權國家"]
    A --> C["1884柏林會議：<br/>歐洲瓜分非洲"]
    A --> D["1919國際聯盟：<br/>文明標準門檻"]
    A --> E["1945聯合國：<br/>大國否決權"]
    C --> F["殖民合法化"]
    D --> G["非歐洲排除"]
    E --> H["强國霸權維持"]
    style F fill:#FF6B6B
