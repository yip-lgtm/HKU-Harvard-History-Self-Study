...
**Style**: 袁騰飛式 — 犀利、聚焦消費文化與女性身體政治的歷史交織
...
```mermaid
flowchart TD
    A[Women's magazine as source<br/>女性雜誌史料] --> B[Surface text<br/>表層文本]
    A --> C[Deep text<br/>深層文本]
    A --> D[Reader responses<br/>讀者回應]
    A --> E[Advertising<br/>廣告]
    
    B --> B1[Fashion & beauty tips<br/>時尚美容建議]
    B --> B2[Recipes & home<br/>食譜與家居]
    B --> B3[Romance stories<br/>愛情故事]
    
    C --> C1[Ideal femininity standards<br/>理想女性標準]
    C --> C2[Consumption ideology<br/>消費意識形態]
    C --> C3[Body discipline<br/>身體規訓]
    
    D --> D1[Letters to the editor<br/>讀者來信<br/>Filtered by editors]
    D --> D2[Reader surveys<br/>讀者調查<br/>often commissioned by advertisers]
    
    E --> E1[Cosmetic ads<br/>化枚品廣告]
    E --> E2[Fashion ads<br/>時尚廣告]
    E --> E3[Weight loss products<br/>減肥產品廣告]
    
    B1 --> F[Historian's interpretation<br/>歷史學家的解讀]
    C1 --> F
    D1 --> F
    E1 --> F
...
```mermaid
graph TD
    A[Feminist waves & magazines<br/>女性主義浪潮與雜誌] --> B[1st wave 1870-1920<br/>投票+教育+財產]
    A --> C[2nd wave 1960-1980<br/>身體+職場+家庭]
    A --> D[3rd wave 1990-2010s<br/>多元+差异+Intersectionality]
    A --> E[Post-feminism 2000s+<br/>赋權叙事+消費主義]
    
    B --> B1[Ladies Home Journal<br/>1883-<br/>話語：家庭天使]
    B --> B2[NO political content<br/>幾乎無政治內容]
    
    C --> C1[Ms. Magazine 1972<br/>話語：政治權力<br/>讀者：小眾精英]
    C --> C2[Mainstream mags resist<br/>主流雜誌抵制女性主義]
    
    D --> D1[Riot Grrrl Zines<br/>1990s<br/>話語：愤怒+另類+身體政治]
    D --> D2[Bitch, Bust, Curve<br/>邊缘女性主義雜誌]
    
    E --> E1[COSMO, Glamour<br/>2000s+<br/>話語：赋權+消費+性解放]
    E --> E2[美麗迷思仍然存在<br/>但用女性主義語言包裝]
...
```mermaid
graph LR
    A[Global magazines<br/>全球雜誌] --> B[US/EU origin<br/>美國/歐洲起源]
    A --> C[Local adaptations<br/>本地化適應]
    
    B --> C1[COSMO US<br/>美國版<br/>強調性解放]
    B --> C2[Vogue France<br/>法國版<br/>強調時尚藝術]
    B --> C3[Vogue China<br/>中國版<br/>強調事業家庭兼顧]
    B --> C4[COSMO HK<br/>香港版<br/>強調都市獨立女性]
    
    C1 --> D[Reader responses<br/>讀者反應]
    C2 --> D
    C3 --> D
    C4 --> D
    
    D --> E[Empowerment<br/>赋權?] 
    D --> F[Resistance<br/>抵抗?]
    D --> G[Hybrid identity<br/>雜糅身份?]
    D --> H[Continuation of patriarchy<br/>父權制延續?]
...
```mermaid
graph LR
    A[1880s-1920s<br/>女性雜誌起源] -->|Ladies Home Journal| B[1920s-1950s<br/>Flapper Era]
    B -->|COSMO 1930s| C[1950s<br/>Post-war domesticity]
    C -->|Ms. Magazine 1972| D[1960s-1980s<br/>Second wave feminism]
    D -->|Bitch, Bust 1990s| E[1990s<br/>Riot Grrrl & third wave]
    E -->|COSMO global 2000s| F[2000s-present<br/>Post-feminism & glocalization]
...
```mermaid
flowchart TD
    A[Women's magazine discourse<br/>女性雜誌話語] --> B[Surface level<br/>表層話語]
    A --> C[Deep level<br/>深層話語]
    A --> D[Commercial level<br/>商業話語]
    
    B --> B1["Be yourself"<br/>做你自己]
    B --> B2["Love your body"<br/>愛你的身體]
    B --> B3["You can have it all"<br/>你可以拥有一切]
    
    C --> C1[You need transformation<br/>你需要改造]
    C --> C2[Consumption = empowerment<br/>消費=赋權]
    C --> C3[Body discipline<br/>身體規訓]
    
    D --> D1[Cosmetic ads<br/>化枚品廣告]
    D --> D2[Fashion ads<br/>時尚廣告]
    D --> D3[Weight loss products<br/>減肥產品]
    
    B1 --> E[Contradiction?<br/>矛盾?]
    C1 --> E
    E --> F[Critical reading<br/>批判性閱讀]
    style A fill:#f96
    style E fill:#f66
```
...
```mermaid
graph LR
    subgraph Western models
        A1[COSMO USA<br/>性解放話語]
        A2[Vogue France<br/>時尚藝術話語]
        A3[Ms. Magazine<br/>政治女性主義]
    end
    
    subgraph Asian adaptations
        B1[COSMO China<br/>事業家庭話語]
        B2[Vogue China<br/>國族資本主義女性]
        B3[香港《姊妹》<br/>工人階級女性]
    end
    
    subgraph South Asian models
        C1[Femina India<br/>傳統+現代話語]
        C2[SheIndia<br/>職業女性話語]
    end
...
```mermaid
graph TD
    A[Feminism & Consumer Culture<br/>女性主義與消費文化的張力] --> B[Feminist Critique<br/>女性主義批判]
    A --> C[Consumer Empowerment<br/>消費赋權論述]
    A --> D[Co-optation Thesis<br/>吸納論述]
    
    B --> B1[Magazines create anxiety<br/>雜誌製造焦慮]
    B --> B2[Consumption = control<br/>消費=控制]
    B --> B3[Beauty myth = patriarchy<br/>美麗迷思=父權制]
    
    C --> C1[Reading is active<br/>閱讀是主動的]
    C --> C2[Women choose empowerment<br/>女性選擇赋權]
    C --> C3[Pleasure is political<br/>快樂是政治的]
    
    D --> D1[Feminism absorbed by capitalism<br/>女性主義被資本主義收編]
    D --> D2["Girl power" = commercial<br/>辣妹力量=商業化]
    D --> D3[Real feminism suppressed<br/>真正女性主義被壓抑]
...
```mermaid
flowchart TD
    A[Women's magazine history<br/>女性雜誌史的擴展] --> B[Traditional approach<br/>傳統方法]
    A --> C[Expanded approach<br/>擴展方法]
    
    B --> B1[Mainstream mags only<br/>只研究主流雜誌]
    B --> B2[English-language only<br/>只看英語材料]
    B --> B3[Middle-class white women<br/>只關注中產階級白人女性]
    
    C --> C1[Include zines & alternatives<br/>包括邊缘雜誌和替代媒體]
    C --> C2[Multi-language sources<br/>多語言一手史料]
    C --> C3[Working-class & minority women<br/>工人階級和少數族裔女性]
    
    B1 -.->|局限性| D1[Majority silenced<br/>大多數女性被消音]
    B2 -.->|局限性| D2[Eurocentric bias<br/>歐洲中心偏見]
    B3 -.->|局限性| D3[Intersectionality ignored<br/>交叉性被忽視]
    
    C1 --> E[More complete picture<br/>更完整的歷史圖景]
    C2 --> E
    C3 --> E
