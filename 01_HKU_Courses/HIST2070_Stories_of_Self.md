...
**Style**: research-based — 犀利批判，聚焦「自我敘事」到底係真相定係意識形態
...
```mermaid
graph TD
    A["自傳文本批判"] --> B["文本分析<br/>語言+結構+主題"]
    A --> C["作者分析<br/>階級+性別+種族"]
    A --> D["語境分析<br/>歷史+政治+文化"]
    A --> E["讀者分析<br/>預期+接受+影響"]
    B --> F["自傳可靠性評估"]
    C --> F
    D --> F
    E --> F
