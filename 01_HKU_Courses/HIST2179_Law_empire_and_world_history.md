...
graph LR
    A["帝國主義擴張"] --> B["建立法庭"]
    B --> C["實施治外法權<br/>外國人不受當地法約束"]
    C --> D["傳播『法治』話語<br/>將殖民正當化"]
    D --> E["帝國控制合法化"]
...
```mermaid
graph LR
    A["海盜船<br/>1716-1726"] --> B["船員投票<br/>選舉船長"]
    A --> C["民主討論<br/>戰利品分配"]
    A --> D["相對平等<br/>的收入分配"]
    B --> E["比同時期歐洲<br/>更民主的制度"]
    C --> E
    D --> E
...
```mermaid
graph TD
    A["國際法『文明標準』"] --> B["『文明國家』<br/>欧洲列強<br/>完整主權"]
    A --> C["『半文明國家』<br/>日本.土耳其<br/>有限主權"]
    A --> D["『不文明國家』<br/>非洲.亞洲<br/>被殖民或半殖民"]
...
```mermaid
graph TD
    A["1842<br/>香港島割讓"] --> B["普通法制度<br/>開始建立"]
    B --> C["1898<br/>新界租借"]
    C --> D["1997<br/>回歸中國"]
    D --> E["普通法延續<br/>一國兩制"]
    E --> F["2020<br/>國安法實施"]
