...
**Style**: 袁騰飛式 — 犀利批判，聚焦食物點解成為歷史上最强嘅階級、帝國、同殖民主義工具
...
```mermaid
graph TD
    A["全球食物不平等"] --> B["生產者：農民<br/>低收入+高風險"]
    A --> C["中間商：跨國公司<br/>最大利潤"]
    A --> D["消費者：<br/>階級分化"]
    B --> E["農民破產"]
    C --> F["利潤最大化"]
    D --> G["健康食物階級化"]
