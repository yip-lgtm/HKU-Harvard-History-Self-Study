...
```mermaid
graph LR
    A["1526 巴布爾建立帝國"] --> B["1556-1605 阿克巴盛世<br/>宗教容忍"]
    B --> C["1658-1659 沙賈汗/泰姬陵<br/>文化融合高峰"]
    C --> D["1658-1707 奥朗則布<br/>宗教迫害"]
    D --> E["1707 帝國分裂"]
    E --> F["1857 被英帝國取代"]
...
```mermaid
graph TD
    A["1947年8月分治"] --> B["死亡人數<br/>100-200萬"]
    A --> C["流離失所<br/>1400萬人"]
    A --> D["婦女暴力<br/>數十萬人"]
...
```mermaid
graph LR
    A["獨立後發展軌跡"] --> B["印度<br/>民主持續<br/>GDP 3.7萬億"]
    A --> C["巴基斯坦<br/>軍民交替<br/>GDP 3760億"]
