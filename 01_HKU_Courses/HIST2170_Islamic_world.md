...
**Style**: 袁騰飛式 — 犀利批判，聚焦伊斯蘭世界點解被西方「神秘化」同「妖魔化」
...
```mermaid
graph TD
    A["伊斯蘭政治形態"] --> B["温和伊斯蘭主義<br/>穆斯林兄弟會"]
    A --> C["革命伊斯蘭主義<br/>伊朗1979"]
    A --> D["聖戰主義<br/>蓋達+ISIS"]
    A --> E["政治伊斯蘭主義<br/>正義與發展黨"]
    B --> F["參與民主"]
    C --> G["建立伊斯蘭共和國"]
    D --> H["游擊戰+恐怖主義"]
    E --> I["選舉政治"]
