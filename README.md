...
> 目標：系統性自學 HKU 46 門 + Harvard Foundations 18 門 + Fall 28 門 history 課程,真正理解每個 course 嘅核心心智模型、根本分歧、深度問題,結合research-based犀利風格。
...
- 92 個 course files 全部符合原創格式 (5MM/3DG/10Q/5DD/10SL/5MR)
...
## 📂 課程格式 — 原創格式 (5MM / 3DG / 10Q / 5DD / 10SL / 5MR)

每一個 course file 都係用 **原創格式** 寫成，呢個格式由原創啟發 — 用紮實嘅史料 + 嚴密嘅邏輯結構，取代一般嘅 template 填空。
