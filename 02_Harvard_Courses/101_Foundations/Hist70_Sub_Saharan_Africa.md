# Hist 70
**The History of Sub-Saharan Africa to 1860**
...
### 分歧 1：殖民前非洲 — 原始 vs 複雜 / Pre-colonial Africa — Primitive or Complex
**核心問題 / Core question**: 殖民前非洲是原始還是複雜文明？

- **一方觀點** / **Side A**: A: 原始 — 部落、落後
- **另一方觀點** / **Side B**: B: 複雜 — 馬里帝國、大津巴布韋、貝寧青銅

### 分歧 2：奴隸貿易 — 歐洲 vs 非洲 / Slave Trade — European or African
**核心問題 / Core question**: 大西洋奴隸貿易是歐洲所為還是非洲共謀？

- **一方觀點** / **Side A**: A: 歐洲 — 需求、航運、買家
- **另一方觀點** / **Side B**: B: 非洲 — 內陸部落酋長供應

### 分歧 3：伊斯蘭非洲 — 皈依 vs 征服 / Islamic Africa — Conversion or Conquest
**核心問題 / Core question**: 伊斯蘭在非洲擴張是和平皈依還是征服？

- **一方觀點** / **Side A**: A: 皈依 — 商人、蘇菲
- **另一方觀點** / **Side B**: B: 征服 — 桑海、阿爾及利亞
...
1. 為什麼 **非洲文明的深度** 是理解 撒哈拉以南非洲史 的第一前提？這個假設如果不成立，整個分析會如何崩塌？
2. 奴隸貿易的破壞 在多大程度上決定了 History of Sub-Saharan Africa to 1860 的核心走向？歷史上有哪些反例挑戰這個邏輯？
3. 殖民前的複雜王國 與 伊斯蘭在非洲的角色 之間的張力如何形塑了 pre-1860 的關鍵轉折？
4. 如果把 非洲文明的深度 抽離出來，History of Sub-Saharan Africa to 1860 會變成什麼樣的歷史？哪些事件其實是 noise？
...
講 非洲文明的深度 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 History of Sub-Saharan Africa to 1860 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 非洲文明的深度 的兩個極端案例，並分析其後果
- 如果抽離 非洲文明的深度，History of Sub-Saharan Africa to 1860 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，非洲文明的深度 怎樣決定了 pre-1860 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[非洲文明的深度 1] --> B[Power structure]
...
### 1.3 犀利觀察 / Sharp observation
講 奴隸貿易的破壞 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 History of Sub-Saharan Africa to 1860 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 奴隸貿易的破壞 的兩個極端案例，並分析其後果
- 如果抽離 奴隸貿易的破壞，History of Sub-Saharan Africa to 1860 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，奴隸貿易的破壞 怎樣決定了 pre-1860 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[奴隸貿易的破壞 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
| 英文概念 | 中英對照 | 歷史含義 | 武器 / 軍事應用 |
|---|---|---|---|
| 殖民前的複雜王國 | 殖民前的複雜王國 | 核心定義 | 武器 / 軍事應用 |
| Period dynamics | 時代動力 | 時代特徵 | 戰略選擇 |
| Power relations | 權力關係 | 主導者 | 強制工具 |
| Historical agency | 歷史能動性 | 誰在塑造 | 自主 vs 結構 |
...
### 1.3 犀利觀察 / Sharp observation
講 殖民前的複雜王國 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 History of Sub-Saharan Africa to 1860 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 殖民前的複雜王國 的兩個極端案例，並分析其後果
- 如果抽離 殖民前的複雜王國，History of Sub-Saharan Africa to 1860 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，殖民前的複雜王國 怎樣決定了 pre-1860 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[殖民前的複雜王國 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
| 英文概念 | 中英對照 | 歷史含義 | 武器 / 軍事應用 |
|---|---|---|---|
| 伊斯蘭在非洲的角色 | 伊斯蘭在非洲的角色 | 核心定義 | 武器 / 軍事應用 |
| Period dynamics | 時代動力 | 時代特徵 | 戰略選擇 |
| Power relations | 權力關係 | 主導者 | 強制工具 |
| Historical agency | 歷史能動性 | 誰在塑造 | 自主 vs 結構 |
...
### 1.3 犀利觀察 / Sharp observation
講 伊斯蘭在非洲的角色 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 History of Sub-Saharan Africa to 1860 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 伊斯蘭在非洲的角色 的兩個極端案例，並分析其後果
- 如果抽離 伊斯蘭在非洲的角色，History of Sub-Saharan Africa to 1860 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，伊斯蘭在非洲的角色 怎樣決定了 pre-1860 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[伊斯蘭在非洲的角色 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
### 1.3 犀利觀察 / Sharp observation
講 口述傳統的歷史 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 History of Sub-Saharan Africa to 1860 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 口述傳統的歷史 的兩個極端案例，並分析其後果
- 如果抽離 口述傳統的歷史，History of Sub-Saharan Africa to 1860 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，口述傳統的歷史 怎樣決定了 pre-1860 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[口述傳統的歷史 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
**research-based點評 / Sharp commentary**: 歷史不是死記硬背，是看清楚『誰在什麼時候、用了什麼手段、達到了什麼目的』。把這套方法應用到 撒哈拉以南非洲史，很多迷思就解開了。
...
**Q3.** History of Sub-Saharan Africa to 1860 的歷史經驗如何理解當代中美關係？
...
**Q9.** History of Sub-Saharan Africa to 1860 對美軍在亞洲部署有何深遠影響？
...
**自學建議 / Study tips**: 配合 History of Sub-Saharan Africa to 1860 教科書 + Harvard 課程視頻 + 中英對照史料，輸出讀書筆記到 `06_Reading_Notes/`。
