...
### 分歧 1：航空 — 解放 vs 帝國 / Aviation — Liberation or Imperialism
**核心問題 / Core question**: 飛機是自由象徵還是帝國工具？

- **一方觀點** / **Side A**: A: 解放 — 民主化國際旅行
- **另一方觀點** / **Side B**: B: 帝國 — 軍事投射、跨國剝削

### 分歧 2：沒有飛機 — 更差 vs 更好 / No Airplanes — Worse or Better
**核心問題 / Core question**: 反事實上沒有飛機世界會更差還是更好？

- **一方觀點** / **Side A**: A: 更差 — 全球化倒退
- **另一方觀點** / **Side B**: B: 更好 — 低碳、本地化

### 分歧 3：航空未來 — 可持續 vs 死亡 / Future of Flight — Sustainable or Dead
**核心問題 / Core question**: 航空業未來是可持續還是會死亡？

- **一方觀點** / **Side A**: A: 可持續 — SAF 燃料、電動飛機
- **另一方觀點** / **Side B**: B: 死亡 — 氣候政策、高鐵替代
...
1. 為什麼 **航空的全球連接** 是理解 沒有飛機的世界 的第一前提？這個假設如果不成立，整個分析會如何崩塌？
2. 航空的環境成本 在多大程度上決定了 World without Airplanes 的核心走向？歷史上有哪些反例挑戰這個邏輯？
3. 航空的地緣政治 與 反事實思考 之間的張力如何形塑了 1903-present 的關鍵轉折？
4. 如果把 航空的全球連接 抽離出來，World without Airplanes 會變成什麼樣的歷史？哪些事件其實是 noise？
...
講 航空的全球連接 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 World without Airplanes 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 航空的全球連接 的兩個極端案例，並分析其後果
- 如果抽離 航空的全球連接，World without Airplanes 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，航空的全球連接 怎樣決定了 1903-present 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[航空的全球連接 1] --> B[Power structure]
...
### 1.3 犀利觀察 / Sharp observation
講 航空的環境成本 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 World without Airplanes 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 航空的環境成本 的兩個極端案例，並分析其後果
- 如果抽離 航空的環境成本，World without Airplanes 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，航空的環境成本 怎樣決定了 1903-present 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[航空的環境成本 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
### 1.3 犀利觀察 / Sharp observation
講 航空的地緣政治 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 World without Airplanes 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 航空的地緣政治 的兩個極端案例，並分析其後果
- 如果抽離 航空的地緣政治，World without Airplanes 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，航空的地緣政治 怎樣決定了 1903-present 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[航空的地緣政治 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
### 1.3 犀利觀察 / Sharp observation
講 反事實思考 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 World without Airplanes 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 反事實思考 的兩個極端案例，並分析其後果
- 如果抽離 反事實思考，World without Airplanes 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，反事實思考 怎樣決定了 1903-present 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[反事實思考 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
### 1.3 犀利觀察 / Sharp observation
講 航空替代方案 不能只講故事，要看『誰贏了、誰輸了、武器怎麼重塑了這個時代』。
很多教科書把 World without Airplanes 講成偉人故事，忽略了背後的權力結構和物質基礎。

### 1.4 Deep test question
- 請舉出歷史上 航空替代方案 的兩個極端案例，並分析其後果
- 如果抽離 航空替代方案，World without Airplanes 的核心敘事會怎樣崩塌？
- 從軍事 / 武器角度，航空替代方案 怎樣決定了 1903-present 的地緣政治？

### 1.5 圖解 / Diagram
```mermaid
graph TD
    A[航空替代方案 1] --> B[Power structure]
    B --> C[Weapons / resources]
    C --> D[Outcome 1]
    C --> E[Outcome 2]
    C --> F[Outcome 3]
...
**research-based點評 / Sharp commentary**: 歷史不是死記硬背，是看清楚『誰在什麼時候、用了什麼手段、達到了什麼目的』。把這套方法應用到 沒有飛機的世界，很多迷思就解開了。
...
**Q3.** World without Airplanes 的歷史經驗如何理解當代中美關係？
...
**Q9.** World without Airplanes 對美軍在亞洲部署有何深遠影響？
...
**自學建議 / Study tips**: 配合 World without Airplanes 教科書 + Harvard 課程視頻 + 中英對照史料，輸出讀書筆記到 `06_Reading_Notes/`。
